...
data = pd.read_csv("contentAffinity.csv")

print(data.head())

y = data.enjoyed
X = data.drop('enjoyed', axis=1)
...
weights = tf.get_variable("weights", dtype=tf.float32, shape=(1,12))
...
with tf.Session() as sess:
    ...
    open("contentrating.tflite", "wb").write(tflite_model)
